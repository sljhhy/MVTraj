...
import argparse
from task import road_cls, speed_inf, time_est, future_grid_pre
...
def evaluation(city, exp_path, model_name, start_time):
    route_min_len, route_max_len, gps_min_len, gps_max_len, grid_min_len, grid_max_len = 7, 100, 7, 256, 7, 100
...
# prepare sequence task
    ...
    print("acc@1:")
    print("============")
    future_grid_pre.evaluation(seq_embedding, dataset, num_nodes, k, acc_at=1)
    print("acc@5:")
    print("============")
    future_grid_pre.evaluation(seq_embedding, dataset, num_nodes, k, acc_at=5)
...
if __name__ == '__main__':
    ...
    exp_path = 'research/exp/JTMR_xian_241204164316'
    model_name = 'JTMR_xian_v1_70_98900_241204164316_64.pt'
